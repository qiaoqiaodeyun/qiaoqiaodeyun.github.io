...
public class AdminServiceImpl implements AdminService{
	...
	public String addAdmin(Admin admin) {
		...
		BaseDao.excuteUpdate(sql, admin.getId(),admin.getName(),admin.getPwd(),admin.getTel());
		return "添加成功";
	}
	...
	public String modifyAdmin(Admin admin) {
		...
		BaseDao.excuteUpdate(sql, admin.getTel(),admin.getName(),admin.getPwd(),admin.getId());
		return "修改成功"; 
	}
